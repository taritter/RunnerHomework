...
void initGrass() {
    grass.setCenter(250, 500);
    grass.setSize(width, height/5);
...
void initBuildings() {
    ...
    while (totalBuildingWidth < width + 100) {
        ...
        buildingSize.height = rand() %101 + 200;
        // Building height between 100-200
        buildingSize.width = rand() %51 + 100;
        // Building width between 50-100
        buildings2.push_back(Rect(darkBlue,totalBuildingWidth+(buildingSize.width/2)+10,
                                  height-((buildingSize.height/2)+50),
                                  buildingSize));
        totalBuildingWidth += buildingSize.width + 10;
    }
    ...
    while (totalBuildingWidth < width + 200) {
        ...
        buildingSize.height = rand() %201 + 400;
        // Building height between 200-400
        buildingSize.width = rand() %101 + 200;
        // Building width between 100-200
        buildings3.push_back(Rect(purple,totalBuildingWidth+(buildingSize.width/2)+15,
                             height-((buildingSize.height/2)+50),
                             buildingSize));
